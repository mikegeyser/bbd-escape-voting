...
mysql -u root -ppassword <<MY_QUERY
	...
	CREATE TABLE KEYSTORE (KEYID varchar(64) NOT NULL, KEYVALUE varchar(1024) NOT NULL, PRIMARY KEY(KEYID));
	INSERT INTO KEYSTORE (KEYID, KEYVALUE) VALUES ('BACKGROUND_ACTIVE', 'FALSE');
	...
	CREATE TABLE COMMENTS(COMMENTID INT AUTO_INCREMENT, COMMENT TEXT, PRESENTER INT, TWEETED BIT DEFAULT 0, TIME TIMESTAMP DEFAULT '2017-06-30 00:00:00', NAME TEXT, PRIMARY KEY(COMMENTID), FOREIGN KEY(PRESENTER) REFERENCES PRESENTER(PRESENTERID));
